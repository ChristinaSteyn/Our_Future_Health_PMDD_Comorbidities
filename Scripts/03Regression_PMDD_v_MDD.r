...
analyze_poisson_model <- function(data, filename, output_prefix = "model_output") {
  ...
  for (comorb in comorbidity_vars) {
    ...
    sep_check <- data.frame(
      Comorbidity = comorb,
      Outcome_0_CTRL = safe_extract(sep_table, "0", "MDD"),
      Outcome_1_CTRL = safe_extract(sep_table, "1", "MDD"),
    ...
    for (model_name in names(model_formulas)) {
      ...
      tryCatch({
        ...
        n_ctrl <- as.numeric(pop_table["MDD"])
...
system(paste("dx upload Broad.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
system(paste("dx upload Broad_separation_diagnostics.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
...
system(paste("dx upload Complications_pregnancy.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
system(paste("dx upload Complications_pregnancy_separation_diagnostics.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
...
system(paste("dx upload Endocrine.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
system(paste("dx upload Endocrine_separation_diagnostics.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
...
system(paste("dx upload Psychiatric.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
system(paste("dx upload Psychiatric_separation_diagnostics.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
...
system(paste("dx upload Neurodev.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
system(paste("dx upload Neurodev_separation_diagnostics.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
...
system(paste("dx upload Reproductive.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
system(paste("dx upload Reproductive_separation_diagnostics.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
...
system(paste("dx upload Autoimmune.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
system(paste("dx upload Autoimmune_separation_diagnostics.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
...
system(paste("dx upload Respiratory.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
system(paste("dx upload Respiratory_separation_diagnostics.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
...
system(paste("dx upload CVD.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
system(paste("dx upload CVD_separation_diagnostics.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
...
system(paste("dx upload Digestive.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
system(paste("dx upload Digestive_separation_diagnostics.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
...
system(paste("dx upload Neurological.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
system(paste("dx upload Neurological_separation_diagnostics.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
...
system(paste("dx upload Depression_subtypes.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
system(paste("dx upload Depression_subtypes_separation_diagnostics.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
...
system(paste("dx upload Depression_pregnancy_subtypes.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
system(paste("dx upload Depression_pregnancy_subtypes_separation_diagnostics.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
...
system(paste("dx upload Multimorbidity.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
system(paste("dx upload Multimorbidity_separation_diagnostics.csv", "--destination", "/Outputs/Regression_comorbidities/PMDD_v_MDD/"), intern = TRUE)
