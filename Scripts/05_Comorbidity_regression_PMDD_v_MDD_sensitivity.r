#Script to perform sensitivity analysis: run sequential logistic regression models 
#comparing the prevalence of each medical condition of interest in PMDD vs MDD
#using complete cases from model 3 (not model 4)
...
test <- na.omit(sub[ ,c("population", "age", "ethnicity","higher_ed", "smoke_tobacco_ever", 
 "alcohol_use", "social_interaction", "composite_sleep_score")])
...
analyze_logistic_model <- function(data, output_prefix = "model_output") {
  ...
  for (comorb in comorbidity_vars) {
    for (model_name in names(model_formulas)) {
      ...
      formula_model3 <- paste(comorb, "~", model_formulas[["model3"]])#This ensures model 1 and 2 are run on same sample as model 3
  ...
  # Write to CSV file
  csv_path <- "All_models_population_summary_sensitivity.csv"
...
system(paste("dx upload All_models_population_summary_sensitivity.csv", "--destination", "/PMDD_outputs/Regression_comorbidities/Broad/"), intern = TRUE)
...
system(paste("dx upload All_models_population_summary_sensitivity.csv", "--destination", "/PMDD_outputs/Regression_comorbidities/Complications_in_pregnancy/"), intern = TRUE)
...
system(paste("dx upload All_models_population_summary_sensitivity.csv", "--destination", "/PMDD_outputs/Regression_comorbidities/Endocrine/"), intern = TRUE)
...
system(paste("dx upload All_models_population_summary_sensitivity.csv", "--destination", "/PMDD_outputs/Regression_comorbidities/Psychiatric/"), intern = TRUE)
...
system(paste("dx upload All_models_population_summary_sensitivity.csv", "--destination", "/PMDD_outputs/Regression_comorbidities/Neurodevelopmental/"), intern = TRUE)
...
system(paste("dx upload All_models_population_summary_sensitivity.csv", "--destination", "/PMDD_outputs/Regression_comorbidities/Reproductive/"), intern = TRUE)
...
system(paste("dx upload All_models_population_summary_sensitivity.csv", "--destination", "/PMDD_outputs/Regression_comorbidities/Autoimmune/"), intern = TRUE)
...
system(paste("dx upload All_models_population_summary_sensitivity.csv", "--destination", "/PMDD_outputs/Regression_comorbidities/Respiratory/"), intern = TRUE)
...
system(paste("dx upload All_models_population_summary_sensitivity.csv", "--destination", "/PMDD_outputs/Regression_comorbidities/CVD/"), intern = TRUE)
...
system(paste("dx upload All_models_population_summary_sensitivity.csv", "--destination", "/PMDD_outputs/Regression_comorbidities/Digestive/"), intern = TRUE)
...
system(paste("dx upload All_models_population_summary_sensitivity.csv", "--destination", "/PMDD_outputs/Regression_comorbidities/Neurological/"), intern = TRUE)
...
system(paste("dx upload All_models_population_summary_sensitivity.csv", "--destination", "/PMDD_outputs/Regression_comorbidities/Multimorbidity/"), intern = TRUE)
